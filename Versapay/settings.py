"""
Django settings for Versapay project.
...
SECRET_KEY = 'django-insecure-j!r13(s66_tcithr%3a1)d_g0p92i8_wp%td%&_o%*^&o((_zc'
...
WSGI_APPLICATION = 'Versapay.wsgi.application'
